...
class StoreLocationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'latitude.required' => 'Pick the location on the map — the pin position is required.',
            'latitude.between'  => 'The map pin latitude is out of range.',
            'longitude.required' => 'Pick the location on the map — the pin position is required.',
            'longitude.between' => 'The map pin longitude is out of range.',
        ];
    }
}
