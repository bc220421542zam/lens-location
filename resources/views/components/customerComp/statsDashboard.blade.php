...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="card card-transition shade bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-indigo-400">
    ...
    <div class="shade card card-transition bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-indigo-600">
        <div class="flex items-center justify-between">
