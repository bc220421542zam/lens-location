...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="card card-transition shade bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-indigo-600">
        <div class="flex justify-between items-start">
            <h3 class="text-xs md:text-sm text-indigo-900 mb-2 md:mb-3">Total Bookings</h3>
            <div class="w-8 h-8 flex items-center justify-center rounded-full bg-indigo-100 text-indigo-600 shrink-0 ml-2">
    ...
    <div class="shade card card-transition bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-amber-600">
        <div class="flex items-center justify-between">
            <p class="label text-xs md:text-sm">Upcoming</p>
            <div class="w-8 h-8 flex items-center justify-center rounded-full bg-amber-100 text-amber-600 shrink-0 ml-2">
    ...
    <div class="shade card card-transition bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-green-600">
        <div class="flex items-center justify-between">
            ...
            <div class="w-8 h-8 flex items-center justify-center rounded-full bg-green-100 text-green-600 shrink-0 ml-2">
    ...
    <div class="card card-transition shade bg-[#EEEFF7] p-4 md:p-5 rounded-2xl border border-l-3 border-red-600">
        <div class="flex justify-between items-start">
            ...
            <div class="w-8 h-8 flex items-center justify-center rounded-full bg-red-100 text-red-500 shrink-0 ml-2">
                <i class="fa-solid fa-calendar-xmark text-sm md:text-base"></i>
            </div>
        </div>
