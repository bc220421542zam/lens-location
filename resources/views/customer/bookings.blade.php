    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 items-stretch">
        @forelse ($bookings as $booking)
            @php
                ...
                // Reviews unlock at payment: the booking is `completed` the
                // moment the charge lands and moves to `visited` once the
                // booking date passes, so both statuses are reviewable.
