...
<div class="page">
    ...
    <div class="top-bar">
        <div>
            ...
            <p class="text-sm text-gray-500">Manage your booking listings</p>
        </div>
    </div>
    {{-- STATS --}}
    ...
    <div class="flex gap-2 mb-4">
        ...
        <button class="action-btn">Upcoming</button>
    ...
    <div class="flex flex-col gap-3">
        <h1 class=" text-indigo-900">Upcoming</h1>
        ...
        <h1 class=" text-indigo-900">Past Bookings</h1>
        <div class="card flex items-center gap-4">
